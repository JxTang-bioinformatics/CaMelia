...
CaMelia does not require installation, just download the necessary files and run them from the command line. The code of CaMelia has been tested in **Windows and Linux** with **Python 2.7 (and 3.6)**.
